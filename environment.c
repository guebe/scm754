...
static const scm_ops_t ops[] =
{
	...
	[SCM_OP_NUMBER_GE] = { ">=", -1 },
	[SCM_OP_NUMBER_EQ] = { "=", -1 },
	[SCM_OP_CHAR_LT] = { "char<?", -1 },
	[SCM_OP_CHAR_LE] = { "char<=?", -1 },
	[SCM_OP_CHAR_GT] = { "char>?", -1 },
	[SCM_OP_CHAR_GE] = { "char>=?", -1 },
	[SCM_OP_CHAR_EQ] = { "char=?", -1 },
	[SCM_OP_CHAR_CI_LT] = { "char-ci<?", -1 },
	[SCM_OP_CHAR_CI_LE] = { "char-ci<=?", -1 },
	[SCM_OP_CHAR_CI_GT] = { "char-ci>?", -1 },
	[SCM_OP_CHAR_CI_GE] = { "char-ci>=?", -1 },
	[SCM_OP_CHAR_CI_EQ] = { "char-ci=?", -1 },
	...
	[SCM_OP_IS_EQ] = { "eq?", 2 },
	[SCM_OP_IS_EQV] = { "eqv?", 2 },
	[SCM_OP_IS_EQUAL] = { "equal?", 2 },
	[SCM_OP_MEMV] = { "memv", 2 },
	[SCM_OP_MEMQ] = { "memq", 2 },
	[SCM_OP_MEMBER] = { "member", 2 },
	[SCM_OP_ASSV] = { "assv", 2 },
	[SCM_OP_ASSQ] = { "assq", 2 },
	[SCM_OP_ASSOC] = { "assoc", 2 },
	...
	[SCM_OP_STRING_SET] = { "string-set!", 3 },
	[SCM_OP_LIST_REF] = { "list-ref", 2 },
...
extern scm_obj_t scm_env_create(void)
{
	...
	symbols = SCM_NIL;
	scm_gc_push(&scm_interaction_environment);
	scm_gc_push(&symbols);
